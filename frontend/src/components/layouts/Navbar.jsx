...
import { resetSchedule } from "../slices/schedule/scheduleSlice";
import { resetMedication } from "../slices/medication/medicationSlice";
        ...
        <header className="border-b-1 relative z-20 w-full border-b border-slate-200 bg-white/90 shadow-lg shadow-slate-700/5 after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
          <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
            <nav
              ...
              className="flex h-full items-stretch justify-between font-medium text-slate-700"
              role="navigation"
            >
              {/*      <!-- Brand logo --> */}
              <Link
            ...
            `}
              ...
              <div className="flex items-center">
                ...
                >
                  {user ? (
                    <>
                      <li role="none" className="flex items-center lg:px-8">
                        <Link
                          onClick={() => setIsToggleOpen(false)}
                          role="menuitem"
                          aria-haspopup="false"
                          className="flex items-center gap-2 my-4 transition-colors duration-300 hover:text-blue-500 focus:text-blue-600 focus:outline-none focus-visible:outline-none"
                          to={"/medication"}
                        >
                      ...
                      <li role="none" className="flex items-center lg:px-8">
                        <Link
                          ...
                          aria-current="page"
                          aria-haspopup="false"
                          className="flex items-center gap-2 my-4 transition-colors duration-300 hover:text-blue-600 focus:text-blue-600 focus:outline-none focus-visible:outline-none"
                          to={"/schedule"}
                        >
                          <span>Schedule</span>
                        </Link>
                      ...
                      <li role="none" className="flex items-center lg:px-8">
                        <Link
                          ...
                          className="flex items-center gap-2 my-4 transition-colors duration-300 hover:text-blue-500 focus:text-blue-600 focus:outline-none focus-visible:outline-none"
                        >
                          <span>{user ? user.name : "Not Found"}</span>
                        </Link>
                      </li>
                      <li role="none" className="flex items-center lg:pl-8">
                        <Link
                          onClick={logoutHandle}
                          role="menuitem"
                          aria-haspopup="false"
                          className="flex items-center gap-2 my-4 transition-colors duration-300 hover:text-red-500 focus:text-blue-600 focus:outline-none focus-visible:outline-none"
                        >
