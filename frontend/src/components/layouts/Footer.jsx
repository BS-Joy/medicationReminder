  ...
  if (user?.userRole === "regular") {
    return (
      <>
        ...
        <footer className="w-full text-blue-200">
          {/*    <!-- Main footer --> */}

          {/*    <!-- Subfooter --> */}
          <div className="py-4 text-sm border-t border-blue-700 bg-blue-600">
            <div className="container px-6 mx-auto">
              <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
                <div className="col-span-2 md:col-span-4 lg:col-span-6">
                  Copyright &copy; 2023 Medication Reminder
                </div>
                <nav
                ...
                >
                  ...
                  <ul className="flex items-center justify-end gap-4">
                    <li>
                      <a
                        href="#"
                        className="transition-colors duration-300 hover:text-blue-100"
                      >
                        <svg
