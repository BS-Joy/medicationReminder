...
const Sidebar = ({ isSidebarOpen }) => {
  return (
    <>
      <aside
        className={`bg-white shadow w-64 min-h-screen flex-shrink-0 transition-transform duration-300 ${
          isSidebarOpen ? "" : "-translate-x-full"
        }`}
      >
        <h1 className="font-bold text-2xl text-center my-9">Admin Panel</h1>
        {/* Logo */}
        ...
        {/* Sidebar Content */}
        <nav className="flex flex-col mt-4 ml-6">
          <Link to="/admin" className="p-4 flex items-center gap-1 hover:bg-blue-700 hover:text-white">
            <MdDashboard />Dashboard
          </Link>
          <Link to="/admin/users" className="p-4 flex items-center gap-1 hover:bg-blue-700 hover:text-white">
            <FaUser />Users
          </Link>
          <Link to="/admin/medications" className="p-4 flex items-center gap-1 hover:bg-blue-700 hover:text-white">
            <GiMedicines />Medications
          </Link>
          <Link to="/admin/schedules" className="p-4 flex items-center gap-1 hover:bg-blue-700 hover:text-white">
            <MdOutlineSchedule />Schedules
          </Link>
        </nav>
      </aside>
    </>
